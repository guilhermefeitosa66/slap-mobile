...
class _AplicativoSlapState extends ConsumerState<AplicativoSlap> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp.router(
      ...
      // Acima do `Navigator`, e por isso sobre qualquer rota: é onde o pedido
      // de entrada de outro aparelho aparece, venha ele no meio de um
      // levantamento ou na lista de inventários.
